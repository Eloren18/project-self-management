...
- **Quick-add bar**: text (Enter adds), project selector (or Ad-hoc), **Mandatory/Optional selector**, deadline picker (calendar + quick options incl. `+3 business days`, week-type deadlines).
